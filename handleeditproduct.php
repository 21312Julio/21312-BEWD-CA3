...
if(empty($error)){
        $sql = "UPDATE product SET name=?, description=?, brand=?, type=?, instock=?, price=?, image=? WHERE id=?";

        $stmt = $conn->prepare($sql);

        $stmt->bind_param("ssssbisi", $name, $description, $brand, $type, $instock, $price, $target_file, $id);
